...
(function($) {
    ...
    function switchStyleFont(styleName) {
        switch(styleName){
            case "TBC Din Mtavruli":
                loadFont("static/assets/fonts/georgian/geostyle.css");
            case "Gugeshashvili_Rachveli":
                loadFont("https://cdn.web-fonts.ge/fonts/gugeshashvili-rachveli/css/gugeshashvili-rachveli.min.css");
                break;
            case "poppins":
